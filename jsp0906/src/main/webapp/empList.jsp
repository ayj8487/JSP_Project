	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<!-- 메인 제목 -->
				<h1 class="app-page-title">회원 조회</h1>
								...
								<fieldset>
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<c:forEach items="${list }" var="emp">
											...
											<tr>
												<td><a href="empInfo.do?empno=${emp.empno }">${emp.empno }</a></td>
												<td>${emp.emp_name }</td>
												<td>${emp.sal }</td>
												<td>${emp.phone }</td>
											</tr>
									...
									<div class="text-center">
										<button class="btn app-btn-primary w-40 theme-btn mx-auto" onclick="location.href='empForm.do';">회원등록</button>
									</div>	
					</div>
					</div>
					</div>
