	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<!-- 메인 제목 -->
				<h1 class="app-page-title">주문 조회</h1>
			...
			<div class="tab-content" id="orders-table-tab-content">
							    ...
							    <div class="table-responsive">
										...
										<!-- 제품 리스트 -->
											<c:forEach var="order" items="${list }">
												<tr>
													...
													<td><a href="oderInfo.do?order_date=${order.order_date }&custcode=${order.custcode}">
														${order.custname }</a>
													</td>
									...
									<div class="text-center">
										<button class="btn app-btn-primary w-40 theme-btn mx-auto" onclick="location.href='order1Form.do';">주문등록</button>
									</div>					
					</div>
					</div>
					</div>
